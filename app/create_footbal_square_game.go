...
func CreateDBFootballSquareGame(ctx context.Context, request *http.Request, dbConnect *db.MySQL) (*CreateFootballSquareGameResponse, error) {
	...
	return &CreateFootballSquareGameResponse{}, errors.New(`unknown sport`)
}

func createDBFootballSquareGame(ctx context.Context, createSquareParams CreateFootballSquareGameParams, dbConnect *db.MySQL) (*CreateFootballSquareGameResponse, error) {
	var createSquareResponse CreateFootballSquareGameResponse
	squareGuid := uuid.New()
